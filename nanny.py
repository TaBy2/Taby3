...
settings = {
    ...
    "message":"บัญชีนี้ได้การป้องกันโดย By.NANNY SOGOOD ระบบได้ทำการบล็อคคุณอัตโนมัติ\nติดต่อเชลบอทรึบอทวี10โทร 099-8393240",
...
def lineBot(op):
    try:
        if op.type == 5:
                line.sendText(op.param1,"บัญชีนี้ได้การป้องกันโดย By.NANNY SOGOOD ระบบได้ทำการบล็อคคุณอัตโนมัติ\nสนใจ บอทสิริวี10 เชลบอทกันรัน บอทป้องกันกลุ่มทุกชนิด ติดต่อ ด้านล่างนี้เลยรึ โทร 099-8393240")
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "แรงสุดกือละบักห่ามึงเอ๊ย")
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "เขาคืนผู้สร้างกลุ่มนี้")
                ...
                elif "ต้น" in msg.text:
                    spl = msg.text.split("ต้น")
                    if spl[len(spl)-1] == "":
